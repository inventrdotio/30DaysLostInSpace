...
/* Today we are going to make a big light turn on to light up our lander! We'll use a LED for now to 
 * test our setup. We will use a special pin on our HERO to control our lander's light.
 * 
...
void loop() {
  ...
  delay(100);                            // Wait for a short time (100 milliseconds) with the light OFF.
}
